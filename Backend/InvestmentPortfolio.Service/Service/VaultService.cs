...
namespace InvestmentPortfolio.Service.Service
{
    public class VaultService:IVaultService
    {
        ...
        {
            return await _vaultRepository.UploadExcelFileAsync(file, fileName);
        }

        public async Task<List<dynamic>> GetAllFilesAsync()
        {
            return await _vaultRepository.GetAllFilesAsync();
        }

        public async Task<FileModel> DownloadFileAsync(int fileId)
        {
            return await _vaultRepository.DownloadFileAsync(fileId);
        }


        public async Task<string> DeleteFileAsync(int fileId)
        {
            return await _vaultRepository.DeleteFileAsync(fileId);
        }

        public async Task<(byte[] FileContent, string FileType)> ViewFileAsync(int fileId)
        {
            return await _vaultRepository.ViewFileAsync(fileId);
        }
