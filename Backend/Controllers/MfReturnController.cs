...
namespace YourProject.Controllers
{
    ...
    public class MutualFundController2 : ControllerBase
    {
        ...
        [HttpPost("getReturns")]
        public async Task<IActionResult> GetReturns(string SchemeCode, List<Transaction> transactions)
        {
            ...
            if(response.IsSuccessStatusCode)
            {
                ...
                var returns = CalculateReturns(navData, transactions);
        ...
        private List<object> CalculateReturns(List<NavData> navData, List<Transaction> transactions)
        {
